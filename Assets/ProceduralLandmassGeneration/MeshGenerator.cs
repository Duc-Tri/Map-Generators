...
namespace ProceduralLandmassGeneration
{
    ...
    public class MeshData
    {
        ...
        Vector3[] CalculateNormals()
        {
            ...
            {
                int normalTriagnleIndex = i * 3;
                int vertexIndexA = triangles[normalTriagnleIndex];
                int vertexIndexB = triangles[normalTriagnleIndex + 1];
                int vertexIndexC = triangles[normalTriagnleIndex + 2];
